...
class AssignmentContainer extends StatelessWidget {
  ...
  const AssignmentContainer({super.key, required this.dataRecieved});
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: TextButton(
                          onPressed: () {
                            vModel.openUploadedAssignment(dataRecieved['doc']);
                          },
                          child: Text(
                            '${dataRecieved['subject']} - ${dataRecieved['assNo']}',
                            style: Style.regular16ptb.copyWith(
